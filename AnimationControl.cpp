...
LoadSpec load_specs[NUM_CHARACTERS] = {
	...
	//LoadSpec(AMC, 1.0f, Color(0.0f,0.0f,0.0f), string("16/16_55.amc"), string("16/16.asf")),
	

	LoadSpec(BVH, 0.2f, Color(0.8f,0.4f,0.8f), string("jack/take1.bvh")),
	LoadSpec(BVH, 0.2f, Color(1.0f,0.4f,0.3f), string("jack/take2.bvh")),
	LoadSpec(BVH, 0.2f, Color(0.0f,1.0f,0.0f), string("jack/take3.bvh"))
	/*
	
	LoadSpec(BVH, 0.2f, Color(0.8f,0.4f,0.8f), string("avoid/Avoid 9.bvh")),
	LoadSpec(BVH, 0.2f, Color(1.0f,0.4f,0.3f), string("avoid/Avoid 8.bvh")),
	LoadSpec(BVH, 0.2f, Color(0.0f,1.0f,0.0f), string("avoid/Avoid 7.bvh"))
	*/
...
bool AnimationControl::updateAnimation(float _elapsed_time)
{
	...
	if (run_time >= next_marker_time && run_time <= max_marker_time)
	{
		...
		//ltoes is from the amc file LeftToeBase is BVH file
